...
class UpgradeRemoval65x extends UpgradeRemoval
{
	...
	$files[] = 'tests/acceptance/modules/Home/HomeCest.php';
        ...
        // SuiteCRM 7.10.19
         $files[] = 'include/Smarty/README';
         $files[] = 'include/Smarty/COPYING.lib';
         $files[] = 'include/Smarty/debug.tpl';
         $files[] = 'include/Smarty/LICENSE';
         $files[] = '.git/objects/pack/pack-783ba56463702352451d0eb4f4c90c36cee2b7bc.pack';
         $files[] = '.git/objects/pack/pack-783ba56463702352451d0eb4f4c90c36cee2b7bc.idx';
return $files;
}
}
